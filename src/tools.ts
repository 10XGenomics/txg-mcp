...
export function registerTools(server: Server) {
  ...
  server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    switch (name) {
      ...
      case "verify_auth":
        return wrapResponse(
          toResponse(await txgCli.runCommand(["auth", "verify"])),
        );
      ...
      case "list_analyses": {
        ...
        return wrapResponse(
          toResponse(
            await txgCli.runCommand(["analyses", "list", params.project_id]),
          ),
        );
      }
      ...
      case "get_analysis_details": {
        ...
        return wrapResponse(
          toResponse(
            await txgCli.runCommand(["analyses", "get", params.analysis_id]),
          ),
        );
      }
      ...
      case "list_analysis_files": {
        ...
        return wrapResponse(
          toResponse(
            await txgCli.runCommand(["analyses", "files", params.analysis_id]),
          ),
        );
      }
      ...
      case "list_annotation_models":
        return wrapResponse(
          toResponse(await txgCli.runCommand(["annotation", "models", "list"])),
        );
      ...
      case "list_fastqs": {
        ...
        return wrapResponse(
          toResponse(
            await txgCli.runCommand(["fastqs", "list", params.project_id]),
          ),
        );
      }
      ...
      case "list_libraries": {
        return wrapResponse(
          toResponse(await txgCli.runCommand(["fastqs", "library"])),
        );
      }
      ...
      case "list_project_files": {
        ...
        return wrapResponse(
          toResponse(
            await txgCli.runCommand(["files", "list", params.project_id]),
          ),
        );
      }
      ...
      case "list_custom_references":
        return wrapResponse(
          toResponse(await txgCli.runCommand(["references", "list"])),
        );
      ...
      case "get_reference": {
        ...
        return wrapResponse(
          toResponse(
            await txgCli.runCommand(["references", "get", params.reference_id]),
          ),
        );
      }
