export function getAggrCsvConfigSpec() {
  return {
    ...
    description:
      "Aggregation CSV for combining multiple Cell Ranger count or multi analyses into a single feature-barcode matrix and analysis.",
    ...
    columns: {
      ...
      molecule_h5: {
        description:
          "Analysis ID in txg://analyses/<analysisID> format. This references the molecule_info.h5 file from a completed Cell Ranger count or multi analysis.",
        required: true,
        type: "string",
